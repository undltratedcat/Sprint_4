...
public class HomePage extends CorePage {
    ...
    private final By orderButtonInHeadderLocator = By.cssSelector(".Header_Nav__AGCXC > button.Button_Button__ra12g");
    //Локатор кнопки заказа в теле сайта
    private final By orderButtonInRoadmapLocator = By.className("Button_Middle__1CSJM");
